...
class TabletCompanyInfoPage extends StatefulWidget {
  const TabletCompanyInfoPage({super.key});

  @override
  State<TabletCompanyInfoPage> createState() => _TabletCompanyInfoPageState();
}

class _TabletCompanyInfoPageState extends State<TabletCompanyInfoPage> {
