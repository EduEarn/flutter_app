...
class MobileCompanyInfoPage extends StatefulWidget {
  const MobileCompanyInfoPage({super.key});

  @override
  State<MobileCompanyInfoPage> createState() => _MobileCompanyInfoPageState();
}

class _MobileCompanyInfoPageState extends State<MobileCompanyInfoPage> {
