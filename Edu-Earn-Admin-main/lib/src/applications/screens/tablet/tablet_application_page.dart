...
class TabletApplicationPage extends StatefulWidget {
  const TabletApplicationPage({super.key});

  @override
  State<TabletApplicationPage> createState() => _TabletApplicationPageState();
}

class _TabletApplicationPageState extends State<TabletApplicationPage> {
