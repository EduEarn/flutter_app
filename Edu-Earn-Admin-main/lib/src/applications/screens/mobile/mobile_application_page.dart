...
class MobileApplicationPage extends StatefulWidget {
  const MobileApplicationPage({super.key});

  @override
  State<MobileApplicationPage> createState() => _MobileApplicationPageState();
}

class _MobileApplicationPageState extends State<MobileApplicationPage> {
